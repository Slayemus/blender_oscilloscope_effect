...
3. Open `visualization.blend` . You’ll see an oscilloscope node group. Select the `.csv` file you just generated. Set the sampling mode to **Audio Sampling / Frames per Second**, then play it back.
